const zhCN = {
  ...
  settings: {
    ...
    timeZone: "应用时区",
    timeZoneDescription: "管理员设置全站时间显示；服务端和数据库仍统一使用 UTC。",
    zhCN: "简体中文",
    enUS: "English",
    light: "浅色模式",
    dark: "深色模式",
    system: "跟随系统",
    pluginToolMenu: "右下角插件工具菜单",
    pluginToolMenuDescription: "显示插件声明的右下角快捷入口，默认开启。",
    homeLayout: "首页调整",
    homeHero: "顶部推荐",
    homeHeroDescription: "展示继续收听和可点击切换的大封面 Hero",
    homeStats: "听书数据",
    homeStatsDescription: "展示最近已听、收藏、书单和历史记录",
  ...
  pluginExtensions: {
    ...
    loading: "正在加载插件页面...",
    loadingUi: "正在加载插件界面...",
    missingEntry: "缺少插件界面入口或访问凭据。",
    navigationBlocked: "已阻止插件界面跳转。",
    openExternalLink: "打开外部链接",
    pageUnavailable: "插件页面不可用",
    pageUnavailableDescription: "插件可能已停用、卸载，或不再声明此入口。",
  },
  mine: {
    defaultUser: "听书用户",
  ...
  player: {
    ...
    byMinutes: "按分钟",
    byEpisodes: "按集数",
    customEpisodes: "自定义集数",
    finishCurrentEpisode: "播完本集",
    finishNEpisodes: "播完 {{count}} 集",
    episodes: "{{count}} 集",
    episodesRemaining: "再播 {{count}} 集后停止",
    chapterList: "章节列表",
    selectChapter: "选集",
    mainChapters: "正文",
    extraChapters: "番外",
  ...
  bookshelf: {
    ...
    metadataLock: "锁定元数据",
    metadataLockHelp: "开启后，自动同步扫描不会覆盖手动编辑或手动刮削的元数据。",
    titleField: "书名",
    authorField: "作者",
    narratorField: "演播者",
  ...
  adminStats: {
    ...
    totalListening: "累计收听",
    progressRecordsDetail: "当前 {{count}} 条进度记录",
    activeUsers: "活跃用户",
    ...
    updateCount: "近14天活跃记录",
    updateCountValue: "{{count}} 条",
    activePeak: "活跃峰值",
  ...
  adminLibraries: {
    ...
    scheduledSync: "定时同步",
    scheduledSyncHelp: "按所选周期自动发起增量同步；已有扫描任务时会跳过本次调度。",
    syncFrequency: "同步频率",
    hourly: "每小时",
    daily: "每天",
    weekly: "每周",
  ...
  adminLogs: {
    ...
    clearConfirm: "确定要清空系统日志、全部插件日志和任务日志吗？",
    taskRecords: "任务记录",
    coreBusiness: "核心业务",
    authSystem: "鉴权系统",
    coreErrors: "核心错误",
    ...
    allSources: "全部来源",
    sourceCode: "插件代码",
    sourceLifecycle: "生命周期",
    sourceRuntime: "运行时",
    sourceGateway: "宿主网关",
    sourceSecurity: "安全检查",
    search: "搜索",
    searchPlaceholder: "搜索消息、事件 ID、运行时或操作...",
    resetFilters: "重置插件日志筛选",
    clear: "清空",
    more: "更多",
    exportAll: "导出所有日志",
    exportErrors: "导出错误日志",
    ...
    unknownStatus: "未知状态",
    messages: {
      "http.error.plugin": "插件请求失败：{{error_type}}（{{status_code}}）",
