const enUS = {
  ...
  settings: {
    ...
    dark: "Dark",
    system: "System",
    pluginToolMenu: "Bottom-right plugin tools",
    pluginToolMenuDescription:
      "Show plugin shortcuts in the existing bottom-right tool menu. Enabled by default.",
  ...
  pluginExtensions: {
    toolMenu: "Plugin tools",
    loading: "Loading plugin page...",
    loadingUi: "Loading plugin UI...",
    missingEntry: "The plugin UI entry or access grant is missing.",
    navigationBlocked: "Plugin UI navigation was blocked.",
    openExternalLink: "Open external link",
    pageUnavailable: "Plugin page unavailable",
    pageUnavailableDescription:
      "The plugin may be disabled, uninstalled, or no longer declare this entry.",
  },
  mine: {
  ...
  player: {
    ...
    byMinutes: "Minutes",
    byEpisodes: "Episodes",
    customEpisodes: "Custom episodes",
    finishCurrentEpisode: "This episode",
    finishNEpisodes: "{{count}} episodes",
    episodes: "{{count}} ep",
    episodesRemaining: "Stops after {{count}} more ep.",
  ...
  bookshelf: {
    ...
    metadataLock: "Lock metadata",
    metadataLockHelp: "When enabled, automatic scans will not overwrite manually edited or scraped metadata.",
    titleField: "Title",
    authorField: "Author",
    ...
    rectCover: "3:4 Ratio",
    squareCoverDefault: "1:1 Square (default)",
  ...
  adminStats: {
    ...
    progressRecordsDetail: "{{count}} current progress records",
    ...
    updateCount: "Activity records (14d)",
    updateCountValue: "{{count}} records",
  ...
  adminLibraries: {
    ...
    localPathRequired: "Choose a local directory",
    ...
    scheduledSyncHelp: "Runs an incremental sync at the selected interval and skips scheduling while a scan is active.",
  ...
  pluginLogs: {
    ...
    total: "{{count}} entries",
    empty: "This plugin has no logs yet",
    loadFailed: "Failed to load plugin logs",
    details: "Details",
  ...
  adminLogs: {
    ...
    pluginRecords: "Plugin Logs",
    allSystemLogs: "All",
    allLevels: "All",
    deleteTaskConfirm: "Delete this task log?",
    clearConfirm: "Clear system logs, all plugin logs, and task logs?",
    ...
    sourceGateway: "Host gateway",
    sourceSecurity: "Security",
    search: "Search",
    searchPlaceholder: "Search messages, event IDs, runtimes, or operations...",
    resetFilters: "Reset plugin log filters",
    clear: "Clear",
    more: "More",
    ...
    messages: {
      "http.error.plugin": "Plugin request failed: {{error_type}} ({{status_code}})",
