...
pub async fn security_headers_middleware(
    ...
    if !is_widget {
        ...
        parts.headers.insert(
            ...
            HeaderValue::from_static("default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self'; connect-src 'self' ws: wss: http: https:; media-src 'self'; manifest-src 'self'; object-src 'none'; frame-ancestors 'none';"),
        );
    } else {
        // Allow framing for widget pages
        parts.headers.insert(
            "Content-Security-Policy",
            HeaderValue::from_static("default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self'; connect-src 'self' ws: wss: http: https:; media-src 'self'; manifest-src 'self'; object-src 'none'; frame-ancestors *;"),
        );
    }
